  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Changes to these settings can affect your entire platform. Please
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={mockSettings.general.registrationEnabled}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
          ...
          >
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="ml-8 space-y-3">
                  <div>
                    ...
                    <Input
                      defaultValue={mockSettings.payment.stripePublishableKey}
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 bg-blue-500 rounded flex items-center justify-center text-xs text-white font-bold">
                      P
                    </div>
                    <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={mockSettings.payment.cashOnDelivery}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Accept insurance claims and co-pays
                    </p>
                  </div>
                  <Switch
                    defaultChecked={mockSettings.payment.insurancePayments}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={mockSettings.sms.enableOrderUpdates}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    defaultChecked={
                      mockSettings.sms.enableDeliveryNotifications
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={mockSettings.sms.enablePromotionalSms}
                  />
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      defaultValue={mockSettings.security.sessionTimeout}
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block">
                    ...
                    <Input
                      defaultValue={mockSettings.security.passwordExpiry}
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block">
                    ...
                    <Input
                      defaultValue={mockSettings.security.maxLoginAttempts}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Switch
                      defaultChecked={mockSettings.security.sslRequired}
                      disabled
                    />
                    <Badge
                      variant="outline"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={mockSettings.security.encryptionEnabled}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={mockSettings.security.ipWhitelisting}
                  />
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      defaultValue={mockSettings.integrations.googleAnalytics}
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block">
                    ...
                    <Input
                      defaultValue={mockSettings.integrations.googleTagManager}
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block">
                    ...
                    <Input
                      defaultValue={mockSettings.integrations.facebookPixel}
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block">
                    ...
                    <Input
                      defaultValue={mockSettings.integrations.intercomAppId}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      defaultValue={mockSettings.api.webhookSecret}
                      className="flex-1"
                    />
                ...
                <div>
                  ...
                  <Input
                    defaultValue={mockSettings.integrations.slackWebhookUrl}
